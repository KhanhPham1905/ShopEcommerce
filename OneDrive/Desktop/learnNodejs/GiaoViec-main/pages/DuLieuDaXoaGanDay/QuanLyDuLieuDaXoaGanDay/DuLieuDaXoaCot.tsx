...
const App: React.FC = () => {
  ...
  const expandable = {
    ...
    expandIcon: ({ expanded, onExpand, record }: { expanded: any, onExpand: any, record: any }) => (
  ...
  return (
    <div>
      ...
      >
        <p
          style={{ textAlign: "center", fontSize: "16px", padding: "18px" }}
        >
        ...
        <div style={{ textAlign: 'center', display: "flex", justifyContent: "space-around" }}>
          ...
          <Button onClick={handleConfirmDelete} style={{ backgroundColor: "#ffa800", color: 'white' }}>Xóa</Button>
        </div>
      </Modal>
      <Modal
