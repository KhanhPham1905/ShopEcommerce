...
const Themtruongtuychinh: React.FC = () => {
    ...
    return (
        <div >
            ...
            <p onClick={showModal} style={{ margin: "0", cursor: "pointer", color: "#4c5bd4" }}>
                <Image width={18} height={18} src="/tr_tuychinh.png" alt="" style={{ marginRight: 10 }} />
                Thêm trường tùy chỉnh
            </p>
            <Modal title='Thêm trường tùy chỉnh' open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
