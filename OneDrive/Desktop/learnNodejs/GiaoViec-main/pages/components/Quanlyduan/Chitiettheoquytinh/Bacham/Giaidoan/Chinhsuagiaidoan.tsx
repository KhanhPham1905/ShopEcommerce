...
import styles from "@/pages/components/Quanlyduan/Chitiettheoquytinh/detail_modal/đánh giá giai đoạn/Danhgiagiaidoan.module.css"
...
const Themquytrinh: React.FC = () => {
    ...
    return (
        <div >
            ...
            <Modal title='Chỉnh sửa giai đoạn' open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
